        ...
        <div className="grid gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-14">
              ...
              <div className="mt-3 flex gap-2 overflow-x-auto pb-2 scrollbar-hide sm:mt-4 sm:gap-3">
                {product.media.map((media, index) => (
                  <button
                    ...
                    className={`relative flex-shrink-0 overflow-hidden rounded-2xl transition-all duration-300 ${
                      index === currentIndex
          ...
          >
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <span
                className={`inline-flex rounded-full px-3 py-1 text-[11px] font-medium ring-1 sm:px-4 sm:py-1.5 sm:text-sm ${
                  product.isActive
